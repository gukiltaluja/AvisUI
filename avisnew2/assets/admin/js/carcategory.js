    ...
    //Default data table
     $('#carCategoryTable_wrapper').DataTable();
      table = $('#carCategoryTable').DataTable( {
      lengthChange: false,
      buttons: [ 'copy', 'excel', 'pdf', 'print', 'colvis' ]
    } );
  debugger
   table.buttons().container().appendTo( '#carCategoryTable_wrapper .row:eq(0) .col-md-6:eq(0)' );
...
function carCategoryCreate()
  {
    var a = document.getElementById("carCategoryName").value;
   if (a == "") {
      swal({
          title: 'Failed',
          text: 'Please Enter carCategory Type',
          icon: 'warning',
      ...
      return;
          ...
          var json={
              "carCategoryName": $("#carCategoryName").val()
          }
//console.log(json);
