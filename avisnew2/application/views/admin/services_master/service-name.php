...
<!--         </ol>-->
  ...
  <button type="button" class="btn btn-primary save" onclick="serviceNameCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
              ...
              <table id="serviceNameTable" class="table table-bordered">
                <thead>
                     <tr>
                        ...
                        <th width="443">Accpac Service Code</th>
                        <th width="443">Status</th>
