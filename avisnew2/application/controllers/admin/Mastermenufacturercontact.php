...
class MasterMenufacturerContact extends CMS_Controller {
	...
	public function addeditmastermenufacturerc($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/manufacturer_master/add-edit-master-menufacturer-contact-details');
		$this->load->view('admin/footer');
	}
