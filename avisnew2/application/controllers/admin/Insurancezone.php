...
class Insurancezone extends CMS_Controller {
	...
	public function addlistinsurancezone($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/insurance_tax_master/add-edit-master-insurance-zone');
		$this->load->view('admin/footer');
	}
