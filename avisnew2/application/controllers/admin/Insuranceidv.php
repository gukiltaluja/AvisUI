...
class InsuranceIdv extends CMS_Controller {
	...
	public function addeditinsuranceidv($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/insurance_tax_master/add-edit-insurance-idv-details');
		$this->load->view('admin/footer');
	}
