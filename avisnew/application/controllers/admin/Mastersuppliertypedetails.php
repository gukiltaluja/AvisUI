...
class MasterSupplierTypeDetails extends CMS_Controller {
	...
	public function addeditmastersuppliertype($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/supplier_master/add-edit-master-supplier-type-details');
		$this->load->view('admin/footer');
	}
