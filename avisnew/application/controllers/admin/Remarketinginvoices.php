...
class Remarketinginvoices extends CMS_Controller {
	...
	public function addeditremarketing($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/invoicing_module/add-edit-re-marketing-invoices');
		$this->load->view('admin/footer');
	}
