...
class MasterInsuranceZoneVehicle extends CMS_Controller {
	...
	public function addeditInsuranceZoneVehicle($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/insurance_tax_master/add-edit-master-insurance-zone-vehical-segment-car-cc');
		$this->load->view('admin/footer');
	}
