...
class MiscellaneousInvoice extends CMS_Controller {
	...
	public function addeditmiscellinvoice($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		// $groups = $this->group_model->getRecords();
		// $data['groups'] = $groups;
		
		// $this->load->view('admin/header', $data);		
		// $this->load->view('admin/sidebar');		
		// $this->load->view('admin/masters/add-edit-master', $data);
		// $this->load->view('admin/footer');
		$this->load->view('admin/header');		
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/invoicing_module/add-edit-miscellaneous-invoice');
		$this->load->view('admin/footer');
	}
