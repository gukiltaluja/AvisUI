<!-- Start wrapper-->
 ...
 <div class="clearfix"></div>  
      ...
      <div class="col-lg-12">
         <div class="card">
          ...
          <div class="form-group col-md-3">
           ...
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="warrantyInYears" placeholder="Warrenty in Months">
           </div>
            ...
            <div class="form-group col-md-3">
              <select id="noOfFreeServices" class="form-control">
              <option>No of Free Service</option>
              </select>
           </div>
  ...
  <button type="submit" class="btn btn-primary save" onclick="serviceScheduleCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
...
<th data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Model&quot;}">Model</th>
<th data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Warranty In Months&quot;}">Warranty In Months</th>
