...
<!--         </ol>-->
  ...
  <div class="row">
      <div class="col-lg-12">
         ...
         <select id="manufacturerId" class="form-control">
             <option value="">Select Mnufacturer</option>
             </select>
           </div>
          ...
          <option value="">Insurence Company Name</option>
          </select>
           </div>
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="insuranceMaxDiscountPercent" placeholder="Insurence Max Discount">
           </div>
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="adwPercentage" placeholder="ADW Percentage">
           </div>
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="interestOnAdw" placeholder="Interest On ADW">
           </div>
            <div class="form-group col-md-3">
          <select id="replacementCarCategoryId" class="form-control">
          <option value="1">Replacement Car Category</option>
          </select>
           </div>
           <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="sacCode" placeholder="SAS Code">
           </div>
  ...
  <button type="submit" class="btn btn-primary save" onclick="modelsCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
