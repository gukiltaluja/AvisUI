...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-12">
        <h4 class="page-title">Bank Maste</h4>
<!--        <ol class="breadcrumb">-->
<!--            <li class="breadcrumb-item"><a href="javaScript:void();">Basic Master-->
<!--</a></li>-->
<!--            <li class="breadcrumb-item"><a href="javaScript:void();">Bank Master</a></li>-->
<!--         </ol>-->
     </div>
     </div>
...
<div class="row">
  ...
  <button type="submit" class="btn btn-primary save" onclick="bankMasterCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
