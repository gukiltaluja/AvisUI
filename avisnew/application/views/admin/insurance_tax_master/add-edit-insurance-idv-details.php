...
<!--         </ol>-->
      ...
      <div class="col-lg-12">
         <div class="card">
          ...
          <div class="form-group col-md-3">
            <input type="text" class="form-control" id="idvPercent" placeholder="IDV Percent">
           </div>
  ...
  <button type="submit" class="btn btn-primary save" onclick="insIdvCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
