...
<!--         </ol>-->
      ...
      <div class="col-lg-12">
         <div class="card">
          ...
          <div class="form-group col-md-6">
            <input type="text" class="form-control" id="accessoriesName" placeholder="Accessories Type/Name">
           </div>
           
           <div class="form-group col-md-6">
            <input type="text" class="form-control" id="PercentageValue" placeholder="Percentage Value">
           </div>
  ...
  <button type="submit" class="btn btn-primary save" onclick="accessoriesTypeCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-bordered" id="accessoriesTypeTable">
                <thead>
                    <tr>
                      <th data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;View &quot;}">View</th>
<th data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Accessories Name&quot;}">Accessories Name</th>
<th data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Percentage Value&quot;0}">Percentage Value</th>
