...
<!--         </ol>-->
  ...
  <button type="submit" class="btn btn-primary cancel">Reset</button>
           ...
           <div class="form-group col-md-4">
            <input type="text" class="form-control" id="vatOnLr" placeholder="VAT On LR">
           </div>
           <div class="form-group col-md-4">
        ...
        <div class="form-check padd mb-2">
            ...
            <div class="form-group col-md-4">
            <input type="text" class="form-control" id="lstNo" placeholder="LST Noo">
           </div>  
            <div class="form-group col-md-4">
            <input type="text" class="form-control" id="purchaseVat" placeholder="Purchase Vat">
           </div>
            <div class="form-group col-md-4">
            <input type="text" class="form-control" id="saleVat" placeholder="Sale Vat">
           </div>
