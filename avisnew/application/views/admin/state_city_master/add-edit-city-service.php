          ...
          <div class="form-group col-md-4">
           ...
           <h4 style="padding-top: 10px; padding-bottom:10px; font-size: 20px;"> service name</h4>
            <div class="row" id="serviceNameId"> 
                  ...
                  <!--  <input type="checkbox" class="form-check-input" name="servicename[]" id="serviceNameId" value="1">-->
                  <!--  <label class="form-check-label" for="check2">Aglient Accident Depreciation Waiver</label>-->
                  <!--  </div>-->
                 </div>
            </div>
      </div>
