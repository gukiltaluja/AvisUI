...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-12">
        <h4 class="page-title">Master Menufacturer Contact Details</h4>
<!--        <ol class="breadcrumb">-->
      ...
      <div class="col-lg-12">
         <div class="card">
           ...
           <div class="pt-4">
            ...
            <input type="text" class="form-control" id="input-1" placeholder="Menufacturer Name" disabled>
           </div>
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Contact Name">
           </div>
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Phone 1">
           </div>
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Phone 2">
           </div>
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Mobile">
           </div>
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Email Id">
           </div>
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Designation">
           </div>
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-1" placeholder="Resion">
           </div>
            
Master Model Details
