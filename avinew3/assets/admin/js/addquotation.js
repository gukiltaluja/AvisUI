              ...
              success: function(data) {
                ...
                $.each(data.data, function (index, datas) 
                    { 
                      ...
                      $(".quotationarea").append('<div class="div-table"><div class="table"> <div claiv class="tr"> <div class="td">'+ i +'</div> <div class="td"> '+ view +' </div> <div class="td">'+ datas.variantDisplayName +'</div> <div class="td">'+ datas.cityName +'</div> <div class="td">'+ datas.mileage +'</div> <div class="td">'+ datas.tenure +'</div> <div class="td">-</div> <div class="td">'+ datas.gstPercentage +'</div> <div class="td">'+ datas.cessPercentage +'</div> <div class="td">'+ datas.mileage +'</div> <div class="td">'+ datas.ex_showroomPrice +'</div> <div class="td">'+ datas.availableDiscount +'</div> <div class="td">'+ datas.availableDiscount +'</div> <div class="td">-</div> <div class="td">-</div> <div class="td">'+ datas.roadTaxAndRegistrationAmt +'</div> <div class="td">Renewal Road Tax </div><div class="td">'+ datas.netPrice +'</div> <div class="td">'+ datas.basePrice +'</div> <div class="td">'+ datas.gstPrice +'</div> <div class="td">'+ datas.cessPrice +'</div> <div class="td">'+ datas.downPayment +'</div> <div class="td">'+ datas.securityDeposit +'</div> <div class="td">'+ datas.roi +'</div> <div class="td">'+ datas.mf +'</div> <div class="td">'+ datas.systemRv +'</div> <div class="td">'+ datas.rvDeviation +'</div> <div class="td">'+ datas.applicableRv +'</div> <div class="td">'+ datas.rvAmount +'</div> <div class="td">'+ datas.gstOnRvAmount +'</div> <div class="td">'+ datas.rvAmountIncGST +'</div> <div class="td">'+ datas.roadTaxEMI +'</div> <div class="td">0.0</div> <div class="td">'+ datas.insuranceEmiPerMonth +'</div> <div class="td">'+ datas.servicesCost +'</div><div class="td">'+ datas.accessoriesCost +'</div> <div class="td">'+ datas.tyres +'</div><div class="td">-</div> <div class="td">-</div> <div class="td">TCS</div> <div class="td">-</div> <div class="td">'+ datas.carEMI +'</div> <div class="td">'+ datas.gstOnCarEMI +'</div> <div class="td">'+ datas.cessOnCarEMI +'</div> <div class="td">'+ datas.totalFMS +'</div> <div class="td">'+ datas.gstOnFMS +'</div> <div class="td">'+ datas.totalLr +'</div> <div class="td">'+ datas.totalGstAmount +'</div> <div class="td">'+ datas.totalGstAmountPerMonth +'</div> <div class="td">'+ datas.totalGstAmountPerYear +'</div> <div class="td">'+ datas.unUtilizedGst +'</div> <div class="td">-</div> <div class="td">'+ datas.diffBetweenUnUtilizedGstAndGstOnRv +'</div> <div class="td">'+ datas.perMonthGstLoss +'</div> <div class="td">Sign Value</div> </div> </div> </div>');
