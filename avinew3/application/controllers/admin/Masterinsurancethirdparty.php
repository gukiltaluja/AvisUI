...
class MasterInsuranceThirdParty extends CMS_Controller {
	...
	public function addeditInsuranceThirdParty($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/insurance_tax_master/add-edit-master-insurance-third-party');
		$this->load->view('admin/footer');
	}
