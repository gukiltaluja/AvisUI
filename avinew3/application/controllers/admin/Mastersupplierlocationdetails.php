...
class MasterSupplierLocationDetails extends CMS_Controller {
	...
	public function addeditmastersupplierlocation($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/supplier_master/add-edit-master-supplier-location');
		$this->load->view('admin/footer');
	}
