...
class MasterRoadTypeTax extends CMS_Controller {
	...
	public function addeditmasterroadtypetx($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/insurance_tax_master/add-edit-master-road-type-tax');
		$this->load->view('admin/footer');
	}
