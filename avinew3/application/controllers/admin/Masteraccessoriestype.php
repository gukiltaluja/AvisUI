...
class MasterAccessoriesType extends CMS_Controller {
	...
	public function addeditaccessoriestype($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/insurance_tax_master/add-edit-master-accessories-type-details');
		$this->load->view('admin/footer');
	}
