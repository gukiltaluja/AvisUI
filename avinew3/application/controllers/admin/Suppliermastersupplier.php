...
class SupplierMasterSupplier extends CMS_Controller {
	...
	public function addeditsuppliermasters($param = '')
	{
		//echo "hello";die;
		// if(is_numeric($param)){
		...
		$this->load->view('admin/sidebar');		
		$this->load->view('admin/supplier_master/add-edit-supplier-master-supplier');
		$this->load->view('admin/footer');
	}
