...
function cityServiceCreate()
  {
    ...
    let arr = vals.split(',');
    let servicenameid = parseInt(vals);
    console.log(vals);
    console.log(arr);
   ...
   debugger
      for (var i = 0; i < data.length; i++) {
       // var edit =  '<a href="'+ data[i].id +'"><i class="fa fa-edit" ></i></a>';
        var edit =  '<a onclick="cityServiceByIdclick('+data[i].id+')" ><i class="fa fa-edit" ></i></a>';
    count++;
    table.row.add([
        count,
        data[i].cityName,
  ...
  var count = 0;  
   debugger
      for (var i = 0; i < servicenamedata.length; i++) {
       ...
       // var edit =  '<a onclick="cityServiceByIdclick('+servicenamedata[i].id+')" ><i class="fa fa-edit" ></i></a>';
    count++;
...
function cityServiceByIdclick(id){
        debugger
          officedata = callajaxByUrlData(cityServiceById,id);
          officedata = officedata.data;
          console.log(id);
          console.log(officedata);
          //alert(manufacturerContact);
          //alert(id);
          // $('#cityServiceId').val(officedata.id);
           $('#cityId').val(officedata.cityId);
           $('#stateId').val(officedata.stateId);
           $('#inputCity').val(officedata.cityName);
           $('#inputState').val(officedata.stateName);
           $('#servicename').val(officedata.serviceId);
        //   var servicenamedata1 = officedata.serviceId
        //   var arrlength servicenamedata1.length;
        //       for (var i = 0; i < arrlength; i++) {
        //         var edit =  '<a href="'+ servicenamedata1[i].id +'"><i class="fa fa-edit" ></i></a>';
        //     count++;
        //     console.lig(edit);
        //   }
        }
