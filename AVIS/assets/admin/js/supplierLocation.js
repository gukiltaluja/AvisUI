  ...
  var count = 0;  
   debugger
      for (var i = 0; i < data.length; i++) {
        ...
        var edit =  '<a onclick="getSupplierLocationByIdclick('+data[i].id+')" ><i class="fa fa-edit" ></i></a>';
    count++;
    table.row.add([
        count,
        data[i].contactName,
...
function getSupplierLocationByIdclick(id){
        debugger
          supplierLocation = callajaxByUrlVarData(getSupplierLocationById,id);
          supplierLocationdata = supplierLocation.data;
          console.log(id);
          console.log(supplierLocationdata);
          //alert(manufacturerContact);
          //alert(id);
           $('#supplierId').val(supplierLocationdata.supplierId);
           $('#supplierLocationId').val(supplierLocationdata.id);
           $('#supplierLocAddress').val(supplierLocationdata.supplierLocAddress);
           $('#supplierLocPhone').val(supplierLocationdata.supplierLocPhone);
           $('#contactPhone').val(supplierLocationdata.contactPhone);
           $('#inputCity').val(supplierLocationdata.cityName);
           $('#inputState').val(supplierLocationdata.stateName);
           $('#supplierEmail').val(supplierLocationdata.supplierEmail);
           $('#accPacCode').val(supplierLocationdata.accPackCode);
           $('#contactName').val(supplierLocationdata.contactName);
        }
    //update start
    function supplierLocationUpdate(){
          debugger
  ...
  "supplierLocAddress": $("#supplierLocAddress").val(),
  "supplierLocPhone": $("#supplierLocPhone").val(),
 // "supplierPincode": $("#supplierEmail").val()
              }
             debugger
      console.log(json);
      debugger
