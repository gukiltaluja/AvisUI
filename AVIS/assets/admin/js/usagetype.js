...
function getusagetypeTable(){
   ...
   debugger
    ...
    var edit =  '<a onclick="getUsageTypeByIdclick('+data[i].id+')" ><i class="fa fa-edit" ></i></a>';
...
function callajaxAsStrData(url,data){
    ...
    function getUsageTypeByIdclick(id){
        debugger
          tyresdata = callajaxByUrlVarData(getUsageTypeById,id);
          tyre = tyresdata.data;
          debugger
          console.log(id);
          console.log(tyre.id);
          //alert(tyre);
          //alert(id);
          $('#usageType').val(tyre.usageType);
          $('#rvCorrection').val(tyre.rvCorrection);
         // $('.update').removeClass('d-none');
          $('#rmtbCorrection').val(tyre.rmtbCorrection);
          $('#usageId').val(tyre.id);
        }
