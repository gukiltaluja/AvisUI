   ...
   debugger
      for (var i = 0; i < data.length; i++) {
       // var edit =  '<a href="'+ data[i].id +'"><i class="fa fa-edit" ></i></a>';
        var edit =  '<a onclick="getTransmissionByIdclick('+data[i].id+')" ><i class="fa fa-edit" ></i></a>';
    count++;
    table.row.add([
        count,
        data[i].transmission,
...
function getTransmissionByIdclick(id){
        debugger
          manufacturerContactsdata = callajaxByUrlVarData(getTransmissionById,id);
          transmission = manufacturerContactsdata.data;
          console.log(id);
          console.log(transmission);
          //alert(manufacturerContact);
          //alert(id);
          $('#transmission').val(transmission.transmission);
          $('#transmissionId').val(transmission.id);
        }
    //update start
    function transmissionUpdate(){
          debugger
        var a = document.getElementById("transmission").value;
       if (a == "") {
          swal({
