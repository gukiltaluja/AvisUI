...
<!--         </ol>-->
  ...
  <button type="submit" class="btn btn-primary save"onclick="stateUpdate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspUpdate</button>
  <button type="submit" class="btn btn-primary cancel">Reset</button>
        ...
        <div class="form-check padd mb-2">
           ...
           <!--</div>    -->
            ...
            <div class="form-group col-md-4">
            <input type="text" class="form-control" id="purchaseVat" placeholder="GST on Vehicle Purchase">
           </div>
           
            <div class="form-group col-md-4">
            <input type="text" class="form-control" id="saleVat" placeholder="GST on Vehicle Sale">
           </div>
