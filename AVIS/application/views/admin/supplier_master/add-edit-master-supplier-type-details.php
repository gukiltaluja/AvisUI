...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-12">
        <h4 class="page-title">SUPPLIER TYPE</h4>
<!--        <ol class="breadcrumb">-->
...
<!--         </ol>-->
      ...
      <div class="col-lg-12">
         <div class="card">
           ...
           <div class="form-group col-md-12">
            <input type="text" class="form-control" id="supplierTypeName" placeholder="Supplier Type Name">
           </div>
  ...
  <button type="submit" class="btn btn-primary save" onclick="supplierTypeCreate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
  <button type="submit" class="btn btn-primary save" onclick="supplierTypeUpdate();"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspUpdate</button>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-bordered" id="supplierTypeTable">
                <thead>
                    <tr>
