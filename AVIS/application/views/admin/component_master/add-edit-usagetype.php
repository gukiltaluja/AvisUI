...
<!--         </ol>-->
      ...
      <div class="col-lg-12">
         <div class="card">
           ...
           <div class="form-group col-md-4">
            <input type="hidden" class="form-control" id="usageId" placeholder="RMTB correction (rs per km)">
           </div>
        ...
        <div class="form-check padd mb-2">
          ...
          <button type="button" class="btn btn-primary save" onclick = "usageTypeCreate()"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspSave</button>
          <button type="button" class="btn btn-primary save" onclick = "userTypeUpdate()"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspUpdate</button>
