...
<!--         </ol>-->
     ...
     <div class="row">
      <div class="col-lg-12">
         <div class="card">
           ...
           <input type="hidden" id="fuelTankTypeId">
           <div class="form-group col-md-6">
  ...
  <button type="submit" class="btn btn-primary save" onclick ="fuelTanktypeUpdate()"><i class="fa fa-address-card-o" aria-hidden="true"></i>  &nbsp&nbspUpdate</button>
