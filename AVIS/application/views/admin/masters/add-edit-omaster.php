...
<div class="clearfix"></div>	
  <div class="content-wrapper">
    <div class="container-fluid">
      <!--Start Dashboard Content-->  		  
        ...
        <!--    <li class="breadcrumb-item"><a href="javaScript:void();">Order Masters</a></li>-->
        <!-- </ol>-->
     </div>
     </div>
 ...
 <div class="form-group col-md-3">
        ...
        <option>...</option>
           ...
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-2" placeholder="Actual Price">
           </div>
           <div class="form-group col-md-3">
            <input type="text" class="form-control" id="input-2" placeholder="Discount Final Price">
           </div>
...
<div class="row">
        <div class="col-lg-12">
          <div class="card">
           ...
           <textarea class="form-control" placeholder="Vehicle Registration Address"></textarea>
           </div>
...
<div class="button">
 ...
 <button type="submit" class="btn btn-primary save">SAVE</button>
        ...
        <h4 style="padding-top: 20px;">INFORMATION</h4>
           ...
           <div class="form-group col-md-3">
            <label for="Supplier">Suppier Payment Date</label>
        ...
        <h4 style="padding-top: 20px;">INVOICING CENTER</h4>
