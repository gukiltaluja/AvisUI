...
<!-- Start wrapper-->
       ...
       <div class="col-lg-8">
          <div class="card">
             ...
             <input type="text" class="form-control" id="clientId" placeholder="Client Id">
              ...
              <div class="form-group col-md-12">                
               <div class="row" style="padding-left:13px;">
                 <div class="card-header text-uppercase col-md-3">Client Car Policy</div>
                 <div class="form-check padd mb-2 col-md-3">
                 <input type="checkbox" class="form-check-input margin-t" onchange="checkval()" id="tft" value="">
                 <label class="form-check-label margin-t" for="tft">Tool for Trade</label>
                 </div>
                 <div class="form-check padd mb-2 col-md-3">
                 <input type="checkbox" class="form-check-input margin-t" onchange="checkval()" id="perkcat" value="">
                 <label class="form-check-label margin-t" for="perkcat">Perk Category</label>
                 </div>
                 <div class="form-check padd mb-2 col-md-3">
                 <input type="checkbox" class="form-check-input margin-t" onchange="checkval()" id="ctc" value="">
                 <label class="form-check-label margin-t" for="ctc">CTC</label>
                 </div>
                 </div>
            </div>
            <div class="form-group col-md-4">
             <input type="text" class="form-control" id="man" placeholder="Master Agreement Number">
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="row" style="padding-left:13px;">
                    <div class="card-header text-uppercase col-md-3">Client Blocking</div>
                 <div class="form-check padd mb-2 col-md-2">
                 <input type="checkbox" class="form-check-input margin-t" id="clblk" onchange="checkval()" value="">
                 </div>
         ...
         <!--   <div class="form-group col-md-12">-->
         <!--       <div class="card-header text-uppercase">Client Blocking</div>-->
         <!--<div class="form-check padd mb-2">-->
         <!--        <input type="checkbox" class="form-check-input" id="check2" value="">-->
         <!--        <label class="form-check-label" for="check2">Client level</label>-->
         <!--        </div>-->
         <!--   </div>-->
         </div>
           </form>
 ...
 <div class="col-lg-4">
          <div class="card jjj">
         <div class="card-header ddd text-uppercase">Credit Risk</div>
          <div class="card-body darpan">
           ...
           <div class="row">
             ...
             <br>
               ...
               <br>
           <div class="form-group col-md-12">
     <label for="formGroupExampleInput">Approved Credit <span class="appr">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Approved</span></label>
     <!--<input type="text" class="form-control" id="formGroupExampleInput" disabled>-->
   </div>
   <div class="form-group col-md-12">
     <label for="formGroupExampleInput2">Balance Credit <span class="appr">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Approved</span></label>
               ...
               <div class="card-body"> 
                 <ul class="nav nav-tabs nav-tabs-danger nav-justified top-icon">
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                     <a class="nav-link" data-toggle="tab" href="#tabe-23"><span class="hidden-xs">Invoicing Parameters</span></a>
                   </li>
                 </ul>
 ...
 <div class="button">
  ...
  <button type="button" class="btn btn-primary save" onclick="addClientCom()">SAVE</button>
           ...
           <form>
               <div class="row">
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="chId" placeholder="Id">
            </div>
            <div class="form-group col-md-3">
  
             <input type="text" class="form-control" id="chBName" placeholder="Name">
            </div>
            <div class="form-group col-md-3">
    
             <input type="text" class="form-control" id="chFunction" placeholder="Function">
            </div>
            <div class="form-group col-md-3">
             
             <input type="text" class="form-control" id="chEmail" placeholder="Email Id">
            </div>
            <div class="form-group col-md-3">
             
             <input type="text" class="form-control" id="chStatus" placeholder="Status">
            </div>
         ...
         <h4 style="padding-top: 20px;">BILLING ADDRESS</h4>
         <div class="row">
 
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="billAdd" placeholder="Address">
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="billAddp" placeholder="Pin code">
            </div>
             <div class="form-group col-md-3" style="position:relative">
                 <input id="billAddc" class="form-control" type="text" name="modelname" placeholder="City">
            </div>
           
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="billAdds" placeholder="State" disabled>
            </div>
            
             <div class="form-group col-md-3">
             <input type="text" class="form-control" id="billAddCo" placeholder="Country" disabled>
            </div>
           
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="billAddgstn" placeholder="GSTN">
            </div>
        </div>
         ...
         <div class="row">
            ...
            <div class="form-group col-md-3">
             ...
             <input type="text" class="form-control" id="vehRegAdd" placeholder="Address">
            </div>
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="vehRegAddp" placeholder="Pin code">
            </div>
             <div class="form-group col-md-3" style="position:relative">
                 <input id="vehRegAddc" class="form-control" type="text" name="modelname" placeholder="City">
            </div>
           
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="vehRegAdds" placeholder="State" disabled>
            </div>
            
             <div class="form-group col-md-3">
            <input type="text" class="form-control" id="vehRegAddCo" placeholder="Country" disabled>
            </div>
             
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="vehRegAddgstn" placeholder="GSTN">
            </div>
        </div>
         ...
         <div class="row">
            ...
            <div class="form-group col-md-3">
             ...
             <input type="text" class="form-control" id="invDispAdd" placeholder="Address">
            </div>
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="invDispAddp" placeholder="Pin code">
            </div>
             <div class="form-group col-md-3" style="position:relative">
                 <input id="invDispAddc" class="form-control" type="text" name="modelname" placeholder="City">
            </div>
          
            <div class="form-group col-md-3">
            <input type="text" class="form-control" id="invDispAdds" placeholder="State" disabled>
            </div>
            
              <div class="form-group col-md-3">
            <input type="text" class="form-control" id="invDispAddCo" placeholder="Country" disabled>
            </div>
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="invDispAddgstn" placeholder="GSTN">
            </div>
        </div>
 
 <div class="button">
  <button type="submit" class="btn btn-primary cancel">CANCEL</button>
  <button type="button" class="btn btn-primary save" onclick="addClientChild()">SAVE</button>
  </div>
           </form>
                   </div>
             ...
             <div class="row" id="row_0">
                 <div class="form-group col-md-2">
                     <input type="text" class="form-control" id="contName" placeholder="Name">
                 </div>
                 <div class="form-group col-md-2">
                     <input type="text" class="form-control" id="contFunction" placeholder="Function">
                 </div>
                <div class="form-group col-md-2">
                     <input type="text" class="form-control" id="contNumber" placeholder="Contact Number">
                </div>
                <div class="form-group col-md-2">
                     <input type="text" class="form-control" id="contEmail" placeholder="Email Id">
                </div>
                <div class="form-group col-md-2">
                    
                     <select id="coord" class="form-control">
         ...
         <div class="button">
  <button type="submit" class="btn btn-primary cancel">CANCEL</button>
  <button type="button" class="btn btn-primary save" onclick= "addClientCont()">SAVE</button>
 </div>
           </form>
                   </div>
 ...
 <h4 style="padding-top: 20px;">PRODUCTS</h4>
            ...
            <div class="form-group col-md-3">
             ...
             <input type="text" class="form-control" id="rvType" placeholder="RV TYPE">
            </div>
        </div>
       <div class="row">
            <div class="form-group col-md-3">
             
             <input type="text" class="form-control" id="devOnRv" placeholder="DEVIATION ON RV (%)">
            </div>
            <div class="form-group col-md-3">
            
             <input type="text" class="form-control" id="rvApp" placeholder="RV % APPLIED">
            </div>
            <div class="form-group col-md-3">
           <select id="insMang" class="form-control">
             <option>INSURANCE MANAGED</option>
         <option value= "Full Term Financed">Full term Financed</option>
         <option value= "Full term Reimbursement">Full term Reimbursement</option>
         <option value= "1st year financed and rest reimbursement">1st year financed and rest reimbursement</option>
         <option value= "1st year complimentary and remaining reimbursement">1st year complimentary and remaining reimbursement</option>
         <option value= "1st year complimentary and remaining financed">1st year complimentary and remaining financed.</option>
         </select>
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="mantDev" placeholder="MAINTENANCE DEVIATION">
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="mantFeeDev" placeholder="MAINTENANCE FEE DEVIATION">
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="forCloserDisc" placeholder="FORECLOSURE DISCOUNTING RATE">
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="forCloseCharges" placeholder="FORECLOSURE CHARGES-">
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="intRateDevi" placeholder="INTEREST RATE DEVIATION">
            </div>
            <div class="form-group col-md-3">
           <select id="mantType" class="form-control">
         ...
         <option>EXCLUDED AVIS SERVICES</option>
            ...
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="roadTaxtT" placeholder="ROAD TAX TYPE">
            </div>
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="reconc" placeholder="RECONCILIATION-">
            </div>  
 
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="tLoss" placeholder="TOTAL LOSS RETENTION-">
            </div>
            <!--<div class="form-group col-md-3">-->
            <!-- <input type="text" class="form-control" id="input-4" placeholder="PENAL INTEREST">-->
            <!--</div> -->
            <div class="form-group col-md-6">
            <textarea class="form-control" id="valSug" name="val-suggestions" rows="5" placeholder="REMARKS"></textarea>
            </div>        
             </div> 
  ...
  <button type="submit" class="btn btn-primary save">SAVE</button>
               ...
               <div class="row">
            <div class="form-group col-md-3">
             <input type="text" class="form-control" id="mop" placeholder="Mode Of Payment">
            </div>
            <div class="form-group col-md-3">
             <select class="form-control" id="inCycle">
            ...
            <div class="form-group col-md-3">
             ...
             <input type="text" class="form-control" id="credP" placeholder="Credit Period">
            </div>
            <div class="form-group col-md-3">
             ...
             <div class="form-group col-md-3 d-none" id="invoicearea">
            ...
            <div class="form-group col-md-6">
             <textarea rows="4" class="form-control" id="invRemarks" placeholder="Remarks"></textarea>
  ...
  <button type="button" class="btn btn-primary save" onclick="addClientInvo()">SAVE</button>
 </div>
           </form>
                   </div>
